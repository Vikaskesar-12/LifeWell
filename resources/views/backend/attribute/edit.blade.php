                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        value="{{ old('name', $attribute->name) }}" placeholder="Enter attribute name"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" id="attributeType" name="type">
                                        ...
                                        <option value="text" {{ $attribute->type === 'text' ? 'selected' : '' }}>Text
                                        </option>
                                        <option value="select" {{ $attribute->type === 'select' ? 'selected' : '' }}>Select
                                        </option>
                                        <option value="multiselect"
                                            {{ $attribute->type === 'multiselect' ? 'selected' : '' }}>Multi Select
                                        </option>
                                        <option value="boolean" {{ $attribute->type === 'boolean' ? 'selected' : '' }}>
                                            Boolean</option>
                                        <option value="textarea" {{ $attribute->type === 'textarea' ? 'selected' : '' }}>
                                            Textarea</option>
                                        <option value="price" {{ $attribute->type === 'price' ? 'selected' : '' }}>Price
                                        </option>
                                        <option value="datetime" {{ $attribute->type === 'datetime' ? 'selected' : '' }}>
                                            Date Time</option>
                                        <option value="date" {{ $attribute->type === 'date' ? 'selected' : '' }}>Date
                                        </option>
                                        <option value="image" {{ $attribute->type === 'image' ? 'selected' : '' }}>Image
                                        </option>
                                        <option value="file" {{ $attribute->type === 'file' ? 'selected' : '' }}>File
                                        </option>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" name="value_per_locale" class="form-check-input"
                                        id="valuePerLocale" {{ $attribute->value_per_locale ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input type="checkbox" name="value_per_channel" class="form-check-input"
                                        id="valuePerChannel" {{ $attribute->value_per_channel ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input type="checkbox" name="is_configurable" class="form-check-input"
                                        id="configurable" {{ $attribute->is_configurable ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input type="checkbox" name="visible_on_front" class="form-check-input"
                                        id="visibleFront" {{ $attribute->visible_on_front ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input type="checkbox" name="is_comparable" class="form-check-input" id="comparable"
                                        {{ $attribute->is_comparable ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input type="checkbox" name="use_in_navigation" class="form-check-input"
                                        id="layered" {{ $attribute->use_in_navigation ? 'checked' : '' }}>
