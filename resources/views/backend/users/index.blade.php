    ...
    <div style="display: flex; justify-content: flex-end; margin-bottom: 10px;">
            <form id="searchingForm" method="GET" style="width: 300px;">
                <div class="input-group">
                    <input type="text" class="form-control searching" name="query" placeholder="Search name..." aria-label="Search" />
                ...
                if(response.status) {
                      ...
                      if(response.data.length > 0) {
                          ...
                          $.each(response.data, function(index, data) {
                              ...
                              var diff = moment(createdAt).fromNow();
                              htmlData += `<tr>
                                ...
                                <td><img src="${image}" class="img-fluid rounded-circle" style="max-width:50px"></td>
                                <td>
                                     ${diff} 
                                </td>
                                <td>${data.role}
                         ...
                         htmlData = `<td>
                                         No User found!!! You can create User
                                      </td>`;
                     }
