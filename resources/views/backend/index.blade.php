...
@section('title', 'LifeWell || DASHBOARD')
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{ \App\Models\Brand::countActiveBrand() }}</div>
                            </div>
                            <div class="col-auto">
                                <i class="fas fa-cubes fa-2x text-gray-300"></i>
                            </div>
            ...
            <!-- Dashboard Card with Warning Alert -->
            <div class="col-xl-4 col-lg-5">
                <div class="card shadow mb-4">
                    <!-- Card Header -->
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            @foreach ($products as $key => $product)
                                @if ($product->stock < 10)
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <!-- Sequential Product ID -->
                                        <span class="badge bg-secondary text-light">
                                            {{ $key + 0 }}
                                        </span>

                                        <!-- Warning Badge with Product Name and Stock -->
                                        <span class="badge bg-warning text-dark stock-alert">
                                            <i class="bi bi-exclamation-triangle fs-3"></i> <!-- Icon with adjusted size -->
                                            ⚠️ <strong style="color: red">{{ $product->title_en }}</strong>: Only
                                            {{ $product->stock }} left
                                        </span>
