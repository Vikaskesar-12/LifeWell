        ...
        <div id="dynamic-fields">
            <div class="title-section" data-index="0">
                <div class="form-group">
                    ...
                    <input id="inputTitle1" type="text" name="question" placeholder="Enter specification Name" value="{{old('question',$faq->question)}}" class="form-control">
                    @error('question')
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="summary" name="answer">{{old('answer',$faq->answer)}}</textarea>
                    @error('answer')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                    </div>
