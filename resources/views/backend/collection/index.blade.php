...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('collection.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Collection</a>
    </div>
    <div class="card-body">
          <!-- Search Bar Section -->
    <div style="display: flex; justify-content: flex-end; margin-bottom: 10px;">
            <form id="searchingForm" style="width: 300px; position: relative;">
                <div class="input-group">
                    <input type="text" class="form-control searching" id="searchInput" placeholder="Search categories..." aria-label="Search" style="padding-right: 40px;" />
                      ...
                      if(response.data) {
                          ...
                          $.each(response.data, function(index, category) {
                              ...
                              htmlData += `<tr>
                                ...
                                <td>
                                    <a href="{{url('admin/collection/')}}/${category.id}/edit" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                                    <form method="POST" action="{{url('admin/collection')}}/${category.id}">
                                        @csrf
                                        @method('delete')
