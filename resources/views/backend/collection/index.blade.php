...
@section('title', 'LIFWEL || Category Page')
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <a href="{{ route('collection.create') }}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
                data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Collection</a>
        </div>
        <div class="card-body">
            <!-- Search Bar Section -->
