...
@section('title','LifeWell || Banner Create')
    ...
    <div class="card-body">
      <form method="post" action="{{route('banners.store')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="url" name="url" placeholder="Enter url"  value="{{old('url')}}" class="form-control">
          @error('url')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="button_text" placeholder="Enter button text"  value="{{old('button_text')}}" class="form-control">
          @error('button_text')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
