...
@section('title', 'LifeWell || Product Variants')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Product Variant Lists</h6>
      <a href="{{route('variant.create',request()->segment(3))}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Product</a>
    </div>
    <div class="card-body">
    <div style="display: flex; justify-content: flex-end; margin-bottom: 10px;">
            <form id="searchingForm" method="GET" style="width: 300px;">
                <div class="input-group">
                    <input type="text" class="form-control searching" name="query" placeholder="Search Titles..." aria-label="Search" />
...
<div class="modal fade" id="specificationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                if(response.status) {
                      ...
                      if(response.data.length > 0) {
                          ...
                          $.each(response.data, function(index, data) {
                              let image = data.product_image ? assetUrl + data.product_image.image : null;
                              htmlData += `<tr>
                                ...
                                <td>
                                    <a href="{{url('admin/variant/edit')}}/${data.product_id}/${data.id}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                                    <form method="POST" action="{{url('admin/variant/delete')}}/${data.id}">
                                        @csrf
                                        @method('delete')
