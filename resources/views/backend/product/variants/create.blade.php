...
<div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Add Product Variant</h6>
      <a href="{{route('product-variant',request()->segment(4))}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User">Product Variant</a>
    </div>
    <div class="card-body">
    @if(session('error'))
        ...
        <div class="product-variant col-md-12" id="product-variant">
          ...
          <div class="row">
            <div class="form-group col-md-4">
              ...
              <input id="variant_title" type="text" name="title" placeholder="Enter old price"  value="{{old('variant_title')}}" class="form-control">
              @error('variant_title')
            ...
            <div class="form-group col-md-4">
              ...
              <select name="collection[]" class="form-control selectpicker"  multiple data-live-search="true">
          ...
          <div class="row">
            <div class="form-group col-md-4">
              ...
              <input id="base_price" type="number" name="base_price" placeholder="Enter old price"  value="{{old('base_price')}}" class="form-control">
              @error('base_price')
              <span class="text-danger">{{$message}}</span>
              @enderror
            </div>
...
<script>
    var cat_id= '{{$product->child_cat_id }}';   
    if(cat_id !=null){
      // Ajax call
      $.ajax({
